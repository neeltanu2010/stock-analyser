...
with right:
    ...
    st.plotly_chart(make_price_chart(hist, name), use_container_width=True)
    st.markdown("</div>", unsafe_allow_html=True)
...
with tab1:
    ...
    with a:
        ...
        st.plotly_chart(make_score_radar(scores), use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
    with b:
...
with tab2:
    ...
    with c1:
        ...
        st.plotly_chart(make_financial_chart(financial_df), use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
    with c2:
        ...
        st.plotly_chart(make_quality_chart(financial_df), use_container_width=True)
        st.markdown("</div>", unsafe_allow_html=True)
